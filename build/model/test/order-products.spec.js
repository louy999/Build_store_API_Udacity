...
var order_products_model_1 = __importDefault(require("../order-products.model"));
...
describe('Order Product Model', function () {
    ...
    describe('Test Order Products Model logic', function () {
        ...
        beforeAll(function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4, productModel.create(product)];
                    case 2:
                        _a.sent();
        ...
        it('Index method should return a list of products in a specific order', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, orderProductModel.index(1)];
                    case 1:
        ...
        it('Show method should return the correct product in a specific order', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, orderProductModel.show(1, 1)];
                    case 1:
